<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewOrder.aspx.cs" Inherits="Bootstrap_testing_User_Guide_ViewOrder" %>
...
<head runat="server">
    ...
    <!-- Page title -->
    <title>Bootstrap testing - Guide - View Orders</title>
...
<body>
    ...
    <div class="main">
        <p class="page-text">This part of the user guide shows how to view a placed order.<br />From the homepage or any page on the system, you need to go onto the <b>View Orders</b> section on the navigation bar on the top of the page. <br />The page looks like this:<br /></p>
        <img style="border: 1px solid black; width: 65%;" src="Guide Screenshots/View Order Screen.png" />
