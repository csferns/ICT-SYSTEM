<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddCustomer.aspx.cs" Inherits="Bootstrap_testing_User_Guide_AddCustomer" %>
...
<head runat="server">
    ...
    <!-- Page title -->
    <title>Bootstrap testing - Guide - Add Customer</title>
