<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddOrder.aspx.cs" Inherits="Bootstrap_testing_User_Guide_AddOrder" %>
...
<head runat="server">
    ...
    <!-- Page title -->
    <title>Bootstrap testing - Guide - Add Order</title>
...
<body>
    ...
    <div class="main">
        <p class="page-text">This part of the user guide shows how to record an order.<br />From the homepage, you need to go onto the Add an Order section on the navigation bar on the top of the page. <br />The page looks like this:</p>
        <img src=""
    </div>
</body>
</html>
