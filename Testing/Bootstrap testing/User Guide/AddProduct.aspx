<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="Bootstrap_testing_User_Guide_AddProduct" %>
...
<head runat="server">
    ...
    <!-- Page title -->
    <title>Bootstrap testing - Guide - Add Products</title>
