<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Download.aspx.cs" Inherits="Bootstrap_testing_User_Guide_Download" %>
...
<body>
    ...
    <div class="main">
        <p class="page-text">Welcome to the Downloads section of the user guide. This part of the User Guide allows you to download a copy of the guide for offline use or ease of use.</p>
    </div>
</body>
</html>
