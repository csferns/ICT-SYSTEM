<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewProduct.aspx.cs" Inherits="Bootstrap_testing_User_Guide_ViewProduct" %>
...
<head runat="server">
    ...
    <!-- Page title -->
    <title>Bootstrap testing - Guide - View Products</title>
...
<body>
    ...
    <div class="main">
        <p class="page-text">This part of the user guide shows how to view products on the database.<br />From the homepage or any page on the system, you need to go onto the <b>View Products</b> section on the navigation bar on the top of the page. <br />The page looks like this:<br /></p>
        <img style="border: 1px solid black; width: 65%;" src="Guide Screenshots/View Products Screen.png" />
