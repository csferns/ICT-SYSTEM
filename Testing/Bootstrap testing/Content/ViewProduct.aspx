<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewProduct.aspx.cs" Inherits="Bootstrap_testing_Content_ViewProduct" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="print">
            <div class="header-container">
                <p class="invoice-text">RMS Product Information</p>
        ...
        <div class="main">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Product ID" DataSourceID="SqlDataSource1" Width="100%">
                <Columns>
