<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Bootstrap_testing_Default" %>
...
<body>
    ...
    <div class="main">
        <p class="page-text">Welcome to the order system. Choose the section you want from the top of the page</p>
    </div>
</body>
</html>
