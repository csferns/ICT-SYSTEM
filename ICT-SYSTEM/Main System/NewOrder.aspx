...
<head runat="server">
    ...
    <script src="NewOrder.aspx.cs"></script>
</head>
<body>
    ...
    <div class="navigation">
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style4"><p class="text">Order ID</p></td>
                    <td>
                        <input id="Text1" type="text" class="auto-style2" /></td>
                </tr>
                <tr>
                    <td class="auto-style5"><p class="text">Product ID</p></td>
                    <td class="auto-style3">&nbsp;</td>
                </tr>
                <tr>
                    <td class="auto-style8"><p class="text">Tracking Number</p></td>
                    <td class="auto-style9"></td>
                </tr>
                <tr>
                    <td class="auto-style4"><p class="text">Unit Price</p></td>
                    <td>
                        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource1" DataTextField="Product Price" DataValueField="Product Price" Height="70%" Width="98%">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style6"><p class="text">Customer ID</p></td>
                    <td class="auto-style7">
                        <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource2" DataTextField="ID" DataValueField="ID" Height="70%" Width="98%">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
        </div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AzureICT-SYSTEMConnectionString %>" SelectCommand="SELECT * FROM [Products]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:AzureICT-SYSTEMConnectionString %>" SelectCommand="SELECT [ID] FROM [Customers]"></asp:SqlDataSource>
    </form>
</body>
</html>
